...
def get_argparser():
    ...
    #Experiment Note
    parser.add_argument('--note',  type=str, default='left_main, right_main',
...
def main():
    ...
    for cur_epoch in range(opts.epoch_num):
        ...
        for (images, labels) in train_loader:
            ...
            lbls = torch.concat([lbl1, lbl2], 1) #[2 2 256 256]
            loss = criterion(outputs[:,1:3], lbls)
            ...
            # loss = 0*loss1 + 1*loss2 + 1*loss3 + 0*loss4
