...
def get_argparser():
    ...
    parser.add_argument('--a1',  type=float, default=0.25)
    parser.add_argument('--a2',  type=float, default=0.2)
    parser.add_argument('--a3',  type=float, default=0.2)
    parser.add_argument('--a4',  type=float, default=0.35)
...
def main():
    ...
    for cur_epoch in range(opts.epoch_num):
        ...
        for (images, labels) in train_loader:
            ...
            loss = opts.a1*loss1 + opts.a2*loss2 + opts.a3*loss3 + opts.a4*loss4
